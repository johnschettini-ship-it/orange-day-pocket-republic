...
const CHARACTERS = [
  ...
  {
    id: "donny",
    name: "Donny Goldtower",
    short: "Goldtower",
    color: "#e8c040",
    accent: "#fff0c0",
    silhouette: "square",
    blurb: "Loud luxury tycoon. Branding turns props gold for chaos cash.",
    power: "Branding",
    powerDesc: "Q: brand nearby objects — coin spike, Heat risk.",
    weakness: "Attracts inspectors and protest energy.",
    best: "Money · spectacle · chaos",
    recruitMod: 0.95,
    speed: 108,
    powerKey: "brand",
  },
